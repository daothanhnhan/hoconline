<?php 
    $product_related1 = $action_product->getListProductRelate_byIdCat_hasLimit(101, 8);//var_dump($product_related1);die;
?>
...
<div class="gb-tintuc-lienquan">
    ...
    <div class="gb-product-top">
        <div class="gb-tintuc-lienquan-title">Lớp học online khác</div>
    </div>
    <!--SHOW PRODUCT ITEM-->
