<?php 
    ...
    function dap_an ($dap_an, $cau_so) {
        ...
        $chon = 0;
        foreach ($_SESSION['tra_loi_de_thi_jlpt_nghe'] as $key => $val) {
            if ($val[0] == $cau_so) {
                $chon = $_SESSION['tra_loi_de_thi_jlpt_nghe'][$key][1];
            }
        }
    ...
    $so_cau_tra_loi = count($_SESSION['tra_loi_de_thi_jlpt_nghe']);
?>
<style>
...
<div class="row">
            ...
            <div class="col-md-12 gb-single-blog_ruouvang-right vien">    
                <!-- <button type="button"><a href="/de-thi-jlpt-phan-thi-nghe/<?= $_GET['trang'] ?>/hoan-thanh">Hoàn thành</a></button> -->
                <div>
                    <audio controls>
...
<table style="">
  ...
  <a href="/de-thi-jlpt-phan-thi-nghe/<?= $_GET['trang'] ?>/hoan-thanh" id="testFinish" class="button">Hoàn thành</a>
</div>
...
<script>
    function check_cau_tra_loi (cau_so, chon, stt) {
        ...
        const xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/tra_loi_cau_jlpt_thi_nghe.php?cau="+cau_so+"&chon="+chon+"&stt="+stt, true);
          xhttp.send();
    }
    ...
    function so_cau_chon (tong) {
      ...
      xhttp.open("GET", "/functions/ajax/tra_loi_cau_jlpt_thi_nghe_chon.php?tong="+tong, true);
      xhttp.send();
    }
</script>
...
// console.log('time');
  ...
  if (distance < 0) {
    ...
    window.location.href = "/de-thi-jlpt-phan-thi-nghe/<?= $_GET['trang'] ?>/hoan-thanh";
  }
}, 1000);
</script>
