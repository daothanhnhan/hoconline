<?php 
    $home_pro_new = $action_product->getListProductSaleOff_hasLimit(12);
    $hoc_cap_bac = $action_product->getProductList_byMultiLevel_orderProductId(102,'desc',$trang,'',$slug);
?>

<div class="gb-tieubieu-product_ruouvang" style=" padding-top: 15px">
    <div class="container">
        ...
        <div class="gb-tieubieu-product_ruouvang-body">
            <div class="gb-tieubieu-product_ruouvang-slide" style="display: flex;flex-wrap: wrap;">
                <?php 
                foreach ($hoc_cap_bac as $item) {
                    $row = $item;
