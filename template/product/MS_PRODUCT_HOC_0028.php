                ...
                <div class="gb-single-blog_ruouvang-right-text">
                        <?php 
                            ...
                            <div class="slide-content" style="display: none;" id="dap-an-nhom-<?= $item_nhom['id'] ?>">
                                <p></p>
                                <table class="khung-listhantu hidden" cellspacing="0" style="width: 100%;">
                                    <tbody>
                                        <tr><td>STT</td><th>Đáp án</th><th>Dịch</th></tr>
                                        <?php 
                                        $d = 0;
                                        foreach ($list_cau_de_thi as $item) { 
                                            $d++;
...
<script>
    function check_cau_tra_loi (cau_so, chon, stt) {
        ...
        const xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/tra_loi_cau_jlpt_dap_an.php?cau="+cau_so+"&chon="+chon+"&stt="+stt, true);
          xhttp.send();
    }
    ...
    function ket_qua (tong_cau) {
        const xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/tra_loi_cau_jlpt_dap_an_ket_qua.php?tong_cau="+tong_cau, true);
          xhttp.send();
    }
</script>
