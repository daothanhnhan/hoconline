<?php 
	...
	function cau_luyen_nghe ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE cau_luyen_nghe SET cau_hoi = '$cau_hoi', cau_1 = '$cau_1', cau_2 = '$cau_2', cau_3 = '$cau_3', cau_4 = '$cau_4', cau_dung = '$cau_dung', mp3 = '$mp3', dap_an = '$dap_an' WHERE id = $id";
	...
	cau_luyen_nghe($_GET['id']);

	$info = $action->getDetail('cau_luyen_nghe', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-luyen-nghe&nhom_luyen_nghe_id=<?= $info['nhom_luyen_nghe_id'] ?>">Quay lại</a><br /><br /></p>     
        ...
        <div class="boxNodeContentPage">
            ...
            <textarea name="dap_an" class="ckeditor"><?= $info['dap_an'] ?></textarea>
        </div>
