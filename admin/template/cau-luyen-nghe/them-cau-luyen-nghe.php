<?php 
	...
	function cau_luyen_nghe ($nhom_luyen_nghe_id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO cau_luyen_nghe (cau_hoi, cau_1, cau_2, cau_3, cau_4, cau_dung, nhom_luyen_nghe_id, mp3, dap_an) VALUES ('$cau_hoi', '$cau_1', '$cau_2', '$cau_3', '$cau_4', '$cau_dung', '$nhom_luyen_nghe_id', '$mp3', '$dap_an')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=cau-luyen-nghe&nhom_luyen_nghe_id='.$nhom_luyen_nghe_id.'"</script>';
			} else {
	...
	cau_luyen_nghe($_GET['nhom_luyen_nghe_id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP">Nhập thông tin câu hỏi luyện nghe<br /><br /></p>     
            <p class="subLeftNCP"><a href="index.php?page=cau-luyen-nghe&nhom_luyen_nghe_id=<?= $_GET['nhom_luyen_nghe_id'] ?>">Quay lại</a><br /><br /></p>     
        ...
        <div class="boxNodeContentPage">
            ...
            <textarea name="dap_an" class="ckeditor"></textarea>
        </div>
