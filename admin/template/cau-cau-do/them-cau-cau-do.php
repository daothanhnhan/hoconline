<?php 
	...
	function cau_cau_do ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO cau_cau_do (cau_hoi, cau_1, cau_2, cau_3, cau_4, cau_dung, nhom_cau_do_id, dich) VALUES ('$cau_hoi', '$cau_1', '$cau_2', '$cau_3', '$cau_4', '$cau_dung', '$id', '$dich')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=cau-cau-do&nhom_cau_do_id='.$id.'"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-cau-do&nhom_cau_do_id=<?= $_GET['id'] ?>">Quay lại</a><br /><br /></p>     
