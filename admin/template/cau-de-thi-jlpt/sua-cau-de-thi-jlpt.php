<?php 
	...
	function cau_de_thi_jlpt ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE cau_de_thi_jlpt SET cau_hoi = '$cau_hoi', cau_1 = '$cau_1', cau_2 = '$cau_2', cau_3 = '$cau_3', cau_4 = '$cau_4', cau_dung = '$cau_dung', dap_an = '$dap_an', dich = '$dich' WHERE id = $id";
	...
	cau_de_thi_jlpt($_GET['id']);

	$info = $action->getDetail('cau_de_thi_jlpt', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-de-thi-jlpt&nhom_de_thi_jlpt_id=<?= $info['nhom_de_thi_jlpt_id'] ?>">Quay lại</a><br /><br /></p>     
