<?php 
	...
	function de_thi_jlpt ($product_id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO de_thi_jlpt (name, note, product_id, mp3, nhom_text_de_thi_jlpt_id) VALUES ('$name', '$note', '$product_id', '$mp3', '$nhom_text_de_thi_jlpt_id')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một đề thi JLPT.\');window.location.href="index.php?page=de-thi-jlpt&product_id='.$product_id.'"</script>';
			} else {
	...
	de_thi_jlpt($_GET['product_id']);

	$nhom_text_de_thi_jlpt = $action->getList('nhom_text_de_thi_jlpt', 'product_id', $_GET['product_id'], 'id', 'asc', '', '', '');
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=de-thi-jlpt&product_id=<?= $_GET['product_id'] ?>">Quay lại</a><br /><br /></p>     
