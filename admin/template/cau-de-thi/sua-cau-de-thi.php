<?php 
	...
	function cau_de_thi ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE cau_de_thi SET name = '$name', cau_1 = '$cau_1', cau_2 = '$cau_2', cau_3 = '$cau_3', cau_4 = '$cau_4', dap_an = '$dap_an', dich = '$dich' WHERE id = $id";
	...
	$info = $action->getDetail('cau_de_thi', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-de-thi&nhom_de_thi_id=<?= $info['nhom_de_thi_id'] ?>">Quay lại</a><br /><br /></p>     
