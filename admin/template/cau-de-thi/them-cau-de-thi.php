<?php 
	...
	function cau_de_thi ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO cau_de_thi (name, cau_1, cau_2, cau_3, cau_4, dap_an, nhom_de_thi_id, dich) VALUES ('$name', '$cau_1', '$cau_2', '$cau_3', '$cau_4', '$dap_an', '$id', '$dich')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=cau-de-thi&nhom_de_thi_id='.$id.'"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-de-thi&nhom_de_thi_id=<?= $_GET['id'] ?>">Quay lại</a><br /><br /></p>     
