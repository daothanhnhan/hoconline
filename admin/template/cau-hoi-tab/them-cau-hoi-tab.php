<?php 
	...
	function cau_hoi_tab ($giao_trinh_tab_phu_id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO cau_hoi_tab (cau_hoi, cau_1, cau_2, cau_3, cau_4, cau_dung, giao_trinh_tab_phu_id, nhom_cau_hoi_tab_id, sort) VALUES ('$cau_hoi', '$cau_1', '$cau_2', '$cau_3', '$cau_4', '$cau_dung', '$giao_trinh_tab_phu_id', '$nhom_cau_hoi_tab_id', '$sort')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=cau-hoi-tab&giao_trinh_tab_phu_id='.$giao_trinh_tab_phu_id.'"</script>';
			} else {
	...
	cau_hoi_tab($_GET['giao_trinh_tab_phu_id']);
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-hoi-tab&giao_trinh_tab_phu_id=<?= $_GET['giao_trinh_tab_phu_id'] ?>">Quay lại</a><br /><br /></p>     
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="cau_1" />
            <p class="titleRightNCP">Câu 2</p>
            <input type="text" class="txtNCP1" name="cau_2" />
            <p class="titleRightNCP">Câu 3</p>
            <input type="text" class="txtNCP1" name="cau_3" />
            <p class="titleRightNCP">Câu 4</p>
            <input type="text" class="txtNCP1" name="cau_4" />
