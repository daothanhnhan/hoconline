...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <!-- <p><a href="index.php?page=bai-hoc-cap-do&product_id=<?= $row['product_id'] ?>">Các bài học</a></p> -->
            <p style="width: 100%;"><a href="index.php?page=giao-trinh-chinh&product_id=<?= $row['product_id'] ?>">Các giáo trình chính</a></p>

            <p style="width: 100%;"><a href="index.php?page=giao-trinh&product_id=<?= $row['product_id'] ?>">Các giáo trình</a></p>

            <p style="width: 100%;"><a href="index.php?page=nhom-text-de-thi-jlpt&product_id=<?= $row['product_id'] ?>">Nhóm của Đề thi JLPT</a></p>
            <p style="width: 100%;"><a href="index.php?page=de-thi-jlpt&product_id=<?= $row['product_id'] ?>">Đề thi JLPT</a></p>

            <p style="width: 100%;"><a href="index.php?page=nhom-de-thi-trac-nghiem&product_id=<?= $row['product_id'] ?>">Nhóm đề thi trắc nghiệm</a></p>
            <p style="width: 100%;"><a href="index.php?page=de-thi-trac-nghiem&product_id=<?= $row['product_id'] ?>">Đề thi trắc nghiệm</a></p>

            <p style="width: 100%;"><a href="index.php?page=nhom-luyen-nghe&product_id=<?= $row['product_id'] ?>">Luyện nghe</a></p>

            <p style="width: 100%;"><a href="index.php?page=nhom-cau-do&product_id=<?= $row['product_id'] ?>">Câu đố</a></p>
