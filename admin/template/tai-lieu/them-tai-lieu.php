<?php 
	...
	function tai_lieu () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO tai_lieu (name, note, file) VALUES ('$name', '$note', '$image')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một tài liệu.\');window.location.href="index.php?page=tai-lieu"</script>';
			} else {
