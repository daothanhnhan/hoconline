<?php 
	...
	function giao_trinh_chinh_bai ($id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE giao_trinh_chinh_bai SET name = '$name', note = '$note', dich = '$dich', sort = '$sort' WHERE id = $id";//echo $sql;
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một giáo trình chính bài.\')</script>';
			} else {
	...
	giao_trinh_chinh_bai($_GET['id']);

	$info = $action->getDetail('giao_trinh_chinh_bai', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=giao-trinh-chinh-bai&giao_trinh_chinh_id=<?= $info['giao_trinh_chinh_id'] ?>">Quay lại</a><br /><br /></p>     
