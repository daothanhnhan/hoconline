<?php 
	...
	function giao_trinh_bai_cau_hoi ($id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE giao_trinh_bai_cau_hoi SET cau_hoi = '$cau_hoi', cau_1 = '$cau_1', cau_2 = '$cau_2', cau_3 = '$cau_3', cau_4 = '$cau_4', cau_dung = '$cau_dung', dap_an = '$dap_an', dich = '$dich' WHERE id = $id";
	...
	giao_trinh_bai_cau_hoi($_GET['id']);

	$info = $action->getDetail('giao_trinh_bai_cau_hoi', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=giao-trinh-bai-cau-hoi&giao_trinh_bai_id=<?= $info['giao_trinh_bai_id'] ?>">Quay lại</a><br /><br /></p>     
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="dap_an" value="<?= $info['dap_an'] ?>" />
