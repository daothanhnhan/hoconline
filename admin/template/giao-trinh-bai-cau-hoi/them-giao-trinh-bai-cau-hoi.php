<?php 
	...
	function giao_trinh_bai_cau_hoi ($giao_trinh_bai_id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO giao_trinh_bai_cau_hoi (cau_hoi, cau_1, cau_2, cau_3, cau_4, cau_dung, dap_an, giao_trinh_bai_id, dich) VALUES ('$cau_hoi', '$cau_1', '$cau_2', '$cau_3', '$cau_4', '$cau_dung', '$dap_an', '$giao_trinh_bai_id', '$dich')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=giao-trinh-bai-cau-hoi&giao_trinh_bai_id='.$giao_trinh_bai_id.'"</script>';
			} else {
	...
	giao_trinh_bai_cau_hoi($_GET['giao_trinh_bai_id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=giao-trinh-bai-cau-hoi&giao_trinh_bai_id=<?= $_GET['giao_trinh_bai_id'] ?>">Quay lại</a><br /><br /></p>     
