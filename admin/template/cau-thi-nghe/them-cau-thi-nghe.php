<?php 
	...
	function cau_thi_nghe ($nhom_thi_nghe_id) {
		global $conn_vn;
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO cau_thi_nghe (cau_hoi, cau_1, cau_2, cau_3, cau_4, cau_dung, nhom_thi_nghe_id, dich) VALUES ('$cau_hoi', '$cau_1', '$cau_2', '$cau_3', '$cau_4', '$cau_dung', '$nhom_thi_nghe_id', '$dich')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=cau-thi-nghe&nhom_thi_nghe_id='.$nhom_thi_nghe_id.'"</script>';
			} else {
	...
	cau_thi_nghe($_GET['nhom_thi_nghe_id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=cau-thi-nghe&nhom_thi_nghe_id=<?= $_GET['nhom_thi_nghe_id'] ?>">Quay lại</a><br /><br /></p>     
