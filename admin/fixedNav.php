    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=tai-lieu" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tài liệu</a>
            </li>

            <!-- <li><a href="index.php?page=bai-cap-do" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Bài cấp độ</a>
            </li> -->

            <!-- <li><a href="index.php?page=de-thi" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đề thi</a>
            </li> -->

            <li><a href="index.php?page=tu-dien" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Từ điển</a>
            </li>

            <li><a href="index.php?page=binh-luan" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Bình luận</a>
            </li>

            <li><a href="index.php?page=tab-chon" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Các tab để chọn</a>
            </li>
